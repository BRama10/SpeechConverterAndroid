...
public class MainActivity4 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private Translator englishMandarinTranslator;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        TranslatorOptions options =
                new TranslatorOptions.Builder()
                        ...
                        .build();
        englishMandarinTranslator = Translation.getClient(options);
    ...
    private void downloadModal(final String input) {
        DownloadConditions conditions = new DownloadConditions.Builder()
                .requireWifi()
                .build();
        englishMandarinTranslator.downloadModelIfNeeded(conditions)
                .addOnSuccessListener(
                        new OnSuccessListener() {
                            @Override
                            public void onSuccess(Object o) {
                                Toast.makeText(MainActivity4.this, "Please wait language modal is being downloaded.", Toast.LENGTH_SHORT).show();
                                Toast.makeText(MainActivity4.this, "Object override {not passing through Void}", Toast.LENGTH_SHORT).show();
    ...
    private void translateLanguage(String text) {
        englishMandarinTranslator.translate(text)
                .addOnSuccessListener(
