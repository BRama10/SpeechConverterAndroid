...
public class MainActivity5 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private Translator englishUrduTranslator;
        ...
        textToSpeech = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int i) {
                if(i != TextToSpeech.ERROR) {
                    textToSpeech.setLanguage(new Locale("ur", "MEX"));
                }
            }
        });
                ...
                .addOnSuccessListener(
                        new OnSuccessListener() {
                            ...
                            public void onSuccess(Object o) {
                                Toast.makeText(MainActivity5.this, "Please wait language modal is being downloaded.", Toast.LENGTH_SHORT).show();
                                Toast.makeText(MainActivity5.this, "Object override {not passing through Void}", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(
                        new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                // ...
                                Toast.makeText(MainActivity5.this, "Fail to download modal", Toast.LENGTH_SHORT).show();
                            }
                        });
    }

    private void translateLanguage(String text) {
        englishUrduTranslator.translate(text)
                .addOnSuccessListener(
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if(String.valueOf(spinner.getSelectedItem()) == "GERMAN") {
            Intent intent= new Intent(MainActivity5.this,MainActivity2.class);
            startActivity(intent);
        }
        else if(String.valueOf(spinner.getSelectedItem()) == "FRENCH") {
